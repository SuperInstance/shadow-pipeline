...
Lossy shadow compression pipeline with ordered stages, fidelity scoring, and human-readable rendering
...
```bash
git clone https://github.com/SuperInstance/shadow-pipeline
cd shadow-pipeline
```
